            ...
            <div key={concert.id} className="relative">
              ...
              <div className="lg:hidden">
                ...
                <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 pt-8 text-center border border-white/10">
                  ...
                  {/* Reserve Button */}
                  <button className="border border-white/50 text-white px-14 py-3 rounded-lg text-[12px] tracking-[1.2px] uppercase font-['Poppins'] font-bold hover:bg-white hover:text-black transition-all duration-300 inline-flex items-center justify-center h-[50px]">
                    Rezervă Loc
                  </button>
                </div>
              </div>
