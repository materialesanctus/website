  ...
  return (
    <section id="concerts" className="bg-[#171718] py-20 relative">
      ...
      <div className="container mx-auto px-4 lg:px-5 relative z-10">
        ...
        {/* Concert Listings */}
        <div className="space-y-12 lg:space-y-7 max-w-6xl mx-auto">
          {concerts.map((concert, index) => (
            <div key={concert.id} className="relative">
              ...
              {/* Concert Card - Mobile: Stack vertically, Desktop: Horizontal */}
              <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6 py-6">
                {/* Date */}
                <div className="w-full lg:w-[394px] py-2 text-center lg:text-left">
                  <h3 className="font-['Poppins'] font-bold text-[22px] lg:text-[28px] text-white tracking-[0.28px] uppercase">
                    {concert.date}
                  </h3>
                </div>
                ...
                <div className="flex-1 text-center py-2">
                  <h4 className="font-['Poppins'] text-[18px] lg:text-[24px] text-white tracking-[0.24px] uppercase mb-2 leading-normal">
                    {concert.venue}
                  </h4>
                  <p className="font-['Inter'] text-[14px] lg:text-[16px] text-white/50 px-4 lg:px-0">
                    {concert.address}
                  </p>
                </div>

                {/* Time and Reserve Button Container - Mobile: Side by side, Desktop: Separate */}
                <div className="flex items-center justify-center lg:justify-end gap-6 lg:gap-6">
                  {/* Time */}
                  <div className="text-center lg:text-right">
                    <span className="font-['Poppins'] font-bold text-[22px] lg:text-[28px] text-white tracking-[0.28px] uppercase">
                      {concert.time}
                    </span>
                  </div>
                  ...
                  <div className="relative flex flex-col items-center">
                    <button className="group hover:opacity-80 transition-opacity">
                      <svg width="80" height="96" viewBox="0 0 104 116" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[80px] h-[96px] lg:w-[104px] lg:h-[116px]">
