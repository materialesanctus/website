        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:gap-12 text-center md:text-left">
          <div className="mb-8 md:mb-0">
            <p className="text-[18px] text-[#1B1C1C] font-['Poppins'] font-normal leading-[29px] mb-4">
              Interested in partnering with us? <br></br>          
          ...
          <button className="w-[305px] border border-[#A26D46] text-[#A26D46] px-8 py-4 rounded-full font-['Poppins'] text-[12px] tracking-[1.8px] uppercase hover:bg-[#A26D46] hover:text-white transition-colors">
            Partner With Us
          </button>
        </div>
      </div>
